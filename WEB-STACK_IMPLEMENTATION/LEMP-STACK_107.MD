#
WEB STACK IMPLEMENTATION (LEMP STACK)- 107
...
![alt text](../WEB-STACK_IMPLEMENTATION/photo/mysql.database.png)
...
```
![alt text](../WEB-STACK_IMPLEMENTATION/photo/mysql.table.png)
